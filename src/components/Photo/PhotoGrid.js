...
const ShareButton = (props) => {
  ...
  return (
    <div className="p-2" onClick={() => shareContent()} >
      ...
      <svg
        className="w-5 h-5 text-black" stroke="currentColor" viewBox="0 0 687.92 687.92">
